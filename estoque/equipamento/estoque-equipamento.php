    ...
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            ...
            <div style="text-align:right; margin-top: 10px; padding-right:23px" class="col-7">
                ...
                <a href="/estoque/equipamento/exportar-equip-geral.php"><button id="btnExportar" type="button" class="btn btn-sm btn-success"><i class="fa-solid fa-download"></i> Exportar dados</button></a>
            </div>
            <?php
