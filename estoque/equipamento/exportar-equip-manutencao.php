<?php
    ...
    $output = "";
    $output = "<td border='1'><b>Tabela de equipamentos em manutenção</b></td>";
    ...
    $query = $conexao->query("SELECT * FROM `equipamentos` WHERE `situacao` = 'Em manutenção'") or die(mysqli_errno());
