...
?>
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            <div class="col-md-6">
                <div style="margin-top: 20px; padding-left: 10px;">
                    <h4><a href="../../equipamento/cadastrar-equipamento.php"><button id="btn-addEstoque" style="font-size: 14px;" type="button" class="btn btn-sm btn-success"><b>+</b> Adicionar</button></a> Equipamentos em manutenção:</h4>
                </div>
            </div>
            <div class="col-md-6">
                <div style="margin-top: 20px; padding-left: 10px; text-align: right;">
                    ...
                    <a href="/estoque/equipamento/exportar-equip-manutencao.php"><button style="padding:5px" id="btnExportar" type="button" class="btn btn-sm btn-success"><i class="fa-solid fa-download"></i> Exportar dados</button></a>
                </div>
            </div>
            <?php
