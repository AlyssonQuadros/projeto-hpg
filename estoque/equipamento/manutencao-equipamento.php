...
<html lang="pt-br">
    <head>
        ...
        <title>HPG - Equipamentos em manutenção</title>
...
<?php
    ...
    $consulta = "SELECT * FROM equipamentos WHERE situacao = 'Em manutenção'";
...
?>
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            <div class="col-5">
                <h4 style="margin-top: 10px; margin-left: 10px;"><a href="../../equipamento/cadastrar-equipamento.php"><button id="btn-addEstoque" style="font-size: 14px;" type="button" class="btn btn-sm btn-success"><b>+</b> Adicionar</button></a> Equipamentos em manutenção:</h4>
            </div>
            ...
            <a href="/estoque/equipamento/estoque-equipamento.php"><button type="button" class="btn btn-sm btn-primary"> Todos</button></a>
                <a href="/estoque/equipamento/em-estoque-equipamento.php"><button type="button" class="btn btn-sm btn-success"><i class="fa-solid fa-box"></i> Em estoque</button></a>
                <a href="/estoque/equipamento/uso-equipamento.php"><button type="button" class="btn btn-sm btn-danger"><i class="fa-solid fa-box-open"></i> Em uso</button></a>
                <a href="/estoque/equipamento/manutencao-equipamento.php"><button type="button" class="btn btn-sm btn-warning"><i class="fa-solid fa-screwdriver-wrench"></i> Em manutenção</button></a>
                <a href="/estoque/equipamento/exportar-equip-manutencao.php"><button id="btnExportar" type="button" class="btn btn-sm btn-success"><i class="fa-solid fa-download"></i> Exportar dados</button></a>
            </div>
            <?php
            ...
            <?php
                ...
                <div class="notification is-success" style="align-items:center; width: 300px; height: 60px; margin-left: 20px;">
                    <button class="delete"></button>
                    <p>Equipamento movido com sucesso</p>
                </div>
                <?php
                endif;
                            ...
                            <div class="btn-group">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" data-toggle="modal" data-target="#modalMove" data-equipid="<?php echo $dado["id_equip"]; ?>" data-equipnome="<?php echo $dado["nome"]; ?>" data-equipobs="<?php echo $dado["descricao"]; ?>" data-equisit="<?php echo $dado["situacao"]; ?>">Mover equipamento</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="modalUsoLabel">Movimentar equipamento</h3>
