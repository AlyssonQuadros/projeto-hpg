...
<html lang="pt-br">
    <head>
        ...
        <title>HPG - Equipamentos em uso</title>
...
<?php
    ...
    $consulta = "SELECT * FROM equipamentos WHERE situacao = 'Em uso'";
...
?>
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            <div class="col-5">
                <h4 style="margin-top: 10px; margin-left: 10px;"><a href="../../equipamento/cadastrar-equipamento.php"><button id="btn-addEstoque" style="font-size: 14px;" type="button" class="btn btn-sm btn-success"><b>+</b> Adicionar</button></a> Equipamentos em uso:</h4>
            </div>
            ...
            <a href="/estoque/equipamento/estoque-equipamento.php"><button type="button" class="btn btn-sm btn-primary"> Todos</button></a>
                ...
                <a href="/estoque/equipamento/exportar-equip-uso.php"><button id="btnExportar" type="button" class="btn btn-sm btn-success"><i class="fa-solid fa-download"></i> Exportar dados</button></a>
            </div>
            <?php
