...
<?php
    ...
    $consulta = "SELECT * FROM equipamentos WHERE excluido = 0 AND situacao = 'Em uso'";
    ...
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            ...
            <a href="/estoque/equipamento/estoque-equipamento.php"><button id="btnTodos" type="button" class="btn btn-sm"> Todos</button></a>
                ...
                <a href="/estoque/equipamento/exportar-equip-uso.php"><button type="button" class="btn btn-sm btn-success"><i class="fa-solid fa-download"></i> Exportar dados</button></a>
            </div>
            <?php
