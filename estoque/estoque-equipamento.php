...
?>
    <body style="background-color: #F5F5F8;">
        ...
        <h4 style="margin-top: 10px; margin-left: 20px; margin-top: 20px">Equipamentos no estoque</h4>
        ...
        <div class="container-fluid mt-3" style="padding-bottom: 50px;">
            <table id="tabelaEquip" class="table table-hover table-bordered" style="border-color: #444444; margin-top:20px; margin-bottom:40px; color:#000000;" border="2">
                <thead>
                    <tr>
                        <th class="th-sm" style="width: 12%; font-size:13px; background-color:#ff8533"><b>Nº Patrimônio</b></th>
                        <th class="th-sm" style="font-size:13px; background-color:#ff8533"><b>Nome</b></th>
                        <th class="th-sm" style="font-size:13px; background-color:#ff8533"><b>Descrição</b></th>
                        <th class="th-sm" style="width: 10%; font-size:13px; background-color:#ff8533"><b>Condição</b></th>
                        <th class="th-sm" style="width: 8%; font-size:13px; background-color:#ff8533"><b>Data</b></th>
                        <th class="th-sm" style="width: 10%; font-size:13px; text-align:center; background-color:#ff8533"><b>Ação</b></th>
                    </tr>
                </thead>
                <tbody>
