...
<html lang="pt-br">
    <head>
        ...
        <title>HPG - Hidrantes ativos</title>
...
<?php
    ...
    $consulta = "SELECT * FROM hidrantes WHERE excluido = 0 AND situacao = 'Ativo'";
...
?>
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            <div class="col-5">
                <h4 style="margin-top: 10px; margin-left: 10px;"><a href="../../hidrante/cadastrar-hidrante.php"><button id="btn-addEstoque" style="font-size: 14px;" type="button" class="btn btn-sm btn-success"><b>+</b> Adicionar</button></a> Hidrantes ativos:</h4>
            </div>
            <div style="text-align:right; margin-top: 10px; padding-right:23px" class="col-7">
                ...
                <a href="/estoque/hidrante/exportar-hidrante-estoque.php"><button id="btnExportar" type="button" class="btn btn-sm btn-success"><i class="fa-solid fa-download"></i> Exportar dados</button></a>
            </div>
            <?php
