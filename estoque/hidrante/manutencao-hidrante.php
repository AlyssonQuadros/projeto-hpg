...
<html lang="pt-br">
    <head>
        ...
        <title>HPG - Hidrantes em manutenção</title>
...
?>
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            <div class="col-5">
                <h4 style="margin-top: 10px; margin-left: 10px;"><a href="../../hidrante/cadastrar-hidrante.php"><button id="btn-addEstoque" style="font-size: 14px;" type="button" class="btn btn-sm btn-success"><b>+</b> Adicionar</button></a> Hidrantes em manutenção:</h4>
            </div>
