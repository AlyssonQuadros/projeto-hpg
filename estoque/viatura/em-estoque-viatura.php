...
<html lang="pt-br">
    <head>
        ...
        <title>HPG - Viaturas em estoque</title>
...
<?php
    ...
    $consulta = "SELECT * FROM viaturas WHERE excluido = 0 AND situacao = 'Em estoque'";
...
?>
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            <div class="col-5">
                <h4 style="margin-top: 10px; margin-left: 10px;"><a href="../../viatura/cadastrar-viatura.php"><button id="btn-addEstoque" style="font-size: 14px;" type="button" class="btn btn-sm btn-success"><b>+</b> Adicionar</button></a> Viaturas em estoque:</h4>
            </div>
