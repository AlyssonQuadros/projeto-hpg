...
<?php
    ...
    if(isset($_GET['search'])){
        ...
        $consulta = "SELECT * FROM viaturas WHERE situacao LIKE '%$filterValues%'";
        $con = $mysqli->query($consulta) or die($mysqli->error);

    }else{
        $consulta = "SELECT * FROM viaturas WHERE excluido = 0";
        $con = $mysqli->query($consulta) or die($mysqli->error);
    }
?>
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            ...
            <form action="" method="GET">
                <div class="input-group mb-3" style="margin-left:10px; margin-top:10px; width:400px;">
                    <h6 style="margin-right:10px;">Filtrar por condição:</h6>
