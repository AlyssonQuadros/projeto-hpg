...
<html lang="pt-br">
    <head>
        ...
        <title>HPG - Viaturas em uso</title>
...
<?php
    ...
    $consulta = "SELECT * FROM viaturas WHERE excluido = 0 AND situacao = 'Em uso'";
...
?>
    <body style="background-color: #F5F5F8;">
        ...
        <div class="row">
            <div class="col-5">
                <h4 style="margin-top: 10px; margin-left: 10px;"><a href="../../viatura/cadastrar-viatura.php"><button id="btn-addEstoque" style="font-size: 14px;" type="button" class="btn btn-sm btn-success"><b>+</b> Adicionar</button></a> Viaturas em uso:</h4>
            </div>
            <div style="text-align:right; margin-top: 10px; padding-right:23px" class="col-7">
                ...
                <a href="/estoque/viatura/exportar-viatura-uso.php"><button id="btnExportar" type="button" class="btn btn-sm btn-success"><i class="fa-solid fa-download"></i> Exportar dados</button></a>
            </div>
            <?php
