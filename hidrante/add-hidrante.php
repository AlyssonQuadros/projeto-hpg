...
$sql = "INSERT INTO hidrantes (nome, endereco, estado, tipo, vazao, pressao, condicao, acesso, lat, lng, imagem, created_at)
        VALUES ('$nome', '$endereco', '$estado', '$tipo', '$vazao', '$pressao', '$condicao', '$acesso', '$lat', '$lng', '$imagem', NOW())";
