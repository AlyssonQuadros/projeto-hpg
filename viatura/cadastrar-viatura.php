...
<div class="x_panel">
    <div class="container-fluid pt-3 text-white text-center">
        ...
        <form action="add-viatura.php" method="POST">
            ...
            <div class="container-sm input-group mb-3" style="margin-top: 20px;">
                ...
                <div class="col-lg-3">
                    <input style="font-size: 15px;" maxlength="4" type="text" class="form-control" id="ano" name="ano" placeholder="Ano do veículo">
                </div>
            </div>
            ...
            <?php
                ...
                <div class="notification is-success" style="width: 290px; height: 80px; margin-left: 500px; margin-top: 20px;">
                    ...
                    <p>Viatura adicionado ao estoque!</p>
                </div>
                <?php
                endif;
